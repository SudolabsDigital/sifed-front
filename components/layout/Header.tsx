      ...
      <div className="mx-auto flex h-24 max-w-[1920px] items-center justify-between px-6 lg:px-12 relative z-50">
        ...
        <div className="flex items-center gap-4 flex-shrink-0 cursor-pointer group">
          <Image
            ...
            width={44}
            height={44}
            className="h-11 w-auto object-contain transition-transform group-hover:scale-105 drop-shadow-sm"
          />
          ...
          <div className="hidden xl:flex items-center gap-3">
            ...
            <div className="flex flex-col justify-center">
              ...
              <span className="font-serif text-lg font-bold leading-none text-brand-950 group-hover:text-brand-600 transition-colors">
                ...
                <div className="max-w-[1920px] mx-auto">
                  <div className="flex">
                    ...
                    <div className="w-1/4 bg-brand-50 p-10 border-r border-border flex flex-col justify-between shrink-0">
                      <div>
                        <span className="text-xs font-bold text-brand-600 uppercase tracking-widest mb-4 block">
                          Destacado
                        </span>
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-2 text-sm font-bold text-brand-950 hover:text-brand-600 transition-colors group/link"
                        >
                          Ver más{" "}
